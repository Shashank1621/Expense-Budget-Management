...
<body style="backgroundcolor:red">
    <div class="container">
        ...
        <div class="top-heading">
            <h1>Expense Budget Management Portal</h1>
        </div>
        <form action="index.php" method="post" onsubmit = "return validate()" id="form1">
            ...
            <div class="group">
                ...
                <input type="text" name="username" id="user1" placeholder="Username"  required>
                <br>
                <small></small>
                </div>
                ...
                <input type="password" name="password" id="pass1" placeholder="Password" autocomplete="on" required>
                <br>
                <small></small>
                </div>

        ...
        <div class="col-12 col-m-12 col-sm-12" >
            <div class="card">
                ...
                <form action="8-Monthly-Detailed.php" method="post" id="mthform" onsubmit = "return validate()">
                    <h1 style="display: block;color:#ff69b4">Monthwise Expense Report</h1>
                        <div class = "mthcontrol">
                            <label style="font-family: 'Source Sans Pro'; font-size: 1.3em;color:brown">From:</label><br>
                            <input class="text-input" type="month" id='mthfrom' value="" name="mthfrom" required="true" style="width: 100%; padding-top: 8px; "><br><br><br>
                            <small></small>
                        </div>
                        <div class = "mthcontrol">
                            <label style="font-family: 'Source Sans Pro'; font-size: 1.3em;color:brown">To:</label><br>
